            ...
            try {
                ...
                switch (choice) {
                    ...
                    case "choose":
                        ...
                        SongRequest songRequset = new SongRequest(singerName, artistSong);
                        if (mSongRequestQueue.contains(songRequset)) {
                            System.out.printf("%n%n%n Whoops %s already requested %s!%n",
                                    singerName,
                                    artistSong);
                            break;
                        }
                        mSongRequestQueue.add(songRequset);
